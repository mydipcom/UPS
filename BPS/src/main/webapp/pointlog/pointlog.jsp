...
<head>
<meta charset="utf-8"/>
<title>PointChange Log List</title>
...
<body class="page-header-fixed">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="portlet box blue-hoki">
							...
							<div class="portlet-body">																
								<table class="table table-striped table-hover table-bordered" id="pointlog_table">
									<thead>
										<tr>
	...
	<script src="../static/js/pointslogTableData.js"></script>
	<script>
	jQuery(document).ready(function() {       
	   Metronic.init(); // init metronic core components
	   Layout.init(); // init current layout	
	   //Demo.init(); // init demo features
	   PointLogTable.init("<c:url value="/"/>");	   
	});
	</script>
</body>
<!-- END BODY -->
